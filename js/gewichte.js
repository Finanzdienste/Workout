...
/* ------------------------------------------------------------------ *
 * Was hier einmal stand: "Wann ein Gewicht reif ist"
 *
 * Rund 180 Zeilen, die ausrechneten, wann die App zum Steigern raten sollte -
 * Serien voller Termine beim selben Gewicht, ein Deckel gegen zu grosse
 * Spruenge, ein gemerktes Nein je Uebung. Raus auf Ansage:
 *
 *     "Es sollen nie Steigerungsvorschlaege kommen. Egal wann."
 *
 * Das ist die saubere Loesung und nicht die faule. Das Signal war von Anfang an
 * duenn: Im Protokoll steht je Satz nur das Gewicht und ein Haken - keine
 * Wiederholungen (ausdruecklich so gewollt: "das ist mit Absicht, Wiederholungen
 * will ich nicht tracken"), keine Anstrengung. "Alle Saetze standen" kann nicht
 * zwischen "gerade so geschafft" und "viel zu leicht" unterscheiden. Wer die
 * Wiederholungen spuert, weiss es besser als jede Rechnung ueber Haken - und
 * der + Knopf an der Gewichtszeile steht ja da.
 *
 * Mit rausgegangen: STEIGERUNG_*, protokollEinheiten(), auftritte(), serie(),
 * reifeUebungen() und die Einstellung steigerungNein. Code, der nie wieder
