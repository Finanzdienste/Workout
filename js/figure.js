...
export const PATTERNS = {
  ...
  thrust: {
    ...
    // Blickwinkel weiter herumgedreht als beim einbeinigen Zwilling: Sobald
    // eine Stange über der Hüfte liegt, muss sie waagerecht dastehen. Bei
    // yaw 20 / pitch -30 lief sie schräg durch den Körper, eine Scheibe oben,
    // eine unten.
    label: 'Hüftstreckung', lie: 'supine', view: [62, -8],
    poses: [
  ...
  pressbar: {
    ...
    // Weiter herumgedreht als beim Kurzhantelmuster, damit die Stange quer
    // im Bild liegt statt schräg durch den Brustkorb.
    label: 'Drücken im Liegen an der Stange', lie: 'supine', view: [58, -10],
    poses: [
